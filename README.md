...
* requires 3.11 or later - to use the "Walrus Operator". From 1 April, 2026 md2pptx only supports 3.11 or later
...
* From 1 April, 2028 expect releases to only support 3.13 or later
